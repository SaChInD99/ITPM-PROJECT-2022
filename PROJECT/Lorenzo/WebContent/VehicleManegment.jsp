...
<head>
    ...
    <title>Vehicle Management - Lorenzo</title>
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4" style="background: red;">Vehicle Management</h3>
                <div class="container">
                    <div class="row">
                        <div class="col"><a href="addVehicle.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: black;">Add Vehicle</button></a> <a href="report/VehicleFleetReport.jsp"> <button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: #ed1c24;">Generate Report</button></a></div>
                    </div>
                </div>
