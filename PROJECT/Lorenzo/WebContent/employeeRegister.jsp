...
<head>
    ...
    <title> Employee Register - Lorenzo</title>
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/js/valid.js">
...
<style>
    ...
    <div class="container" style=" background-image: url("assets/img/empr.jpg") border-color: var(--bs-red);">
                             ...
                             <label for="fName"><b>Name</b></label>
                                ...
                                <div class="row mb-3">
                                 <label for="tel"><b>Telephone Number</b></label>
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="tel" id="tel" placeholder="Telephone Number" name="tel" inputmode="numeric" style="border-radius: 0px;" required="required"></div>
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="number" id="age" placeholder="Age" name="age" inputmode="numeric" style="border-radius: 0px;" required="required" ></div>
                                </div>
                                ...
                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit"  style="border-radius: 0px;border-color: var(--bs-green);background: var(--bs-green);">Register Account</button>
                                <hr>
                            </form>
