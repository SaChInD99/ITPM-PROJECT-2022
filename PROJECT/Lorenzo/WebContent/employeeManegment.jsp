    ...
    <jsp:include page="header.jsp"/>
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4" style="margin-bottom: 26px; background: #ed1c24;">Employee Management</h3>
                 <div class="row">
                        <div class="col"><a href="employeeRegister.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: black;">Register New Employee</button></a> <a href="report/employeereport.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: #ed1c24;">Generate Report</button></a></div>
                    </div>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <% for(Employee employee : employeeList){ %>
                                        <tr>
                                            <td style="color: var(--bs-red);"><%=employee.getId() %></td>
