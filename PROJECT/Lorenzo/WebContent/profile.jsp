        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: black;">
                ...
                <div class="container-fluid">
                    <h3 class="text-red mb-4"> Profile</h3>
                    <div class="row mb-3">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                             <form class="user" action="customerProfileUpdate" method="post">
				                                ...
				                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">Update details</button>
				                                <hr>
				                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                              <form class="user" action="employeeProfileUpdate" method="post">
				                                ...
				                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;border-color: var(--bs-orange);background: var(--bs-orange);">Confirm details</button>
				                                <hr>
				                            </form>
                                        </div>
                                    </div>
