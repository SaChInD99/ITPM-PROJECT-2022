                        ...
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                            ...
                            <div class="navbar-header">
                                <!-- Navbar Brand --><a href="#" class="navbar-brand d-none d-sm-inline-block">
                                    <div class="brand-text d-none d-lg-inline-block mr-5"><span>Lorenzo</span><strong> Management System Reports</strong></div>
                    ...
                    <header class="page-header" style="background-color: #495057">
                        <div class="container-fluid">
                            <div class="row">
                             ...
                             <div class="row">
                                 <div class="col-4    pt-4" style="text-align: left;"><p style="font-size: 20px; color: #dae0e5"> Accident Service report  </p></div> 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <%
                                        ...
                                        List<Accident> list = service.getAccidentList();
                                        int i=0;
                                        Double tot = 0.0;
                                    %>
                                    <table class="table  " style="width: 100%;font-size: 18px;" id="table" >
                                                   ...
                                                   <tr> 
                                                        ...
                                                        <td><%=accident.getId()%></td>
                                                         ...
                                                         <td><%=accident.getDate()%></td> 
                                                         <td><%=accident.getTime()%></td> 
                                                         <td><%=accident.getVehicleType()%></td> 
...
//                                                                data.text
                                                                        ...
                                                                        pdfMake.createPdf(docDefinition).download("AccidentService_report.pdf");
                                                                    }
                                                                });
                                                            }
