                        ...
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                            ...
                            <div class="navbar-header">
                                <!-- Navbar Brand --><a href="#" class="navbar-brand d-none d-sm-inline-block">
                                    ...
                                    <input type="button" onclick="Export()" value="Download" class="btn btn-primary" style="background: var(--bs-red);border-radius: 0px;">
                                    <a > </a>         
                            </div>
                ...
                <div class="content-inner"id="canvas" style="width:100%;">
                    ...
                    <header class="page-header" style="background-color: #495057">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-4"></div>
                                <div class="col-4  " style="text-align: center;"><p style="font-size: 50px;font-family: serif; font-weight: bolder; color: #007bff">Lorenzo Rent-A-Car</p></div>
                                <div class="col-4"></div>                                
                            </div> 
                             <div class="row">
                                 <div class="col-4    pt-4" style="text-align: left;"><p style="font-size: 20px; color: #dae0e5"> Vehicle return report  </p></div> 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <%
                                        ...
                                        List<VehicleReturn> list = service.listVehicleReturn();
                                        int i=0;
                                        Double tot = 0.0;
                                    %>
                                    <table class="table  " style="width: 100%;font-size: 18px;" id="table" >
                                                    ...
                                                    <tbody>
                                                   <%for (VehicleReturn vReturn:list){
                                                       i++; 
                                                   %>
                                                   <tr> 
                                                        <td><%=i%></td>
                                                        <td><%=vReturn.getVehicleNumber()%></td> 
                                                         <td><%=vReturn.getCusName()%></td>  
                                                         <td><%=vReturn.getEmail()%></td> 
                                                         <td><%=vReturn.getContact()%></td> 
                                                         <td><%=vReturn.getPickupDate()%></td> 
                                                         <td><%=vReturn.getReturnDate()%></td> 
                                                         <td><%=vReturn.getReturnTime()%></td> 
                                                         <td><%=vReturn.getVehicleType()%></td>
                                                         <td><%=vReturn.getServiceType()%></td>  
...
//                                                                data.text
                                                                        ...
                                                                        pdfMake.createPdf(docDefinition).download("Vehicle _return_report.pdf");
                                                                    }
                                                                });
                                                            }
