                    ...
                    <header class="page-header" style="background-color: #495057">
                        <div class="container-fluid">
                            <div class="row">
                             ...
                             <div class="row">
                                 <div class="col-4    pt-4" style="text-align: left;"><p style="font-size: 20px; color: #dae0e5"> Vehicle Fleet report  </p></div> 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <%
                                        ...
                                        List<Vehicle> list = service.getVehicleList();
                                        int i=0;
                                        Double tot = 0.0;
                                    %>
...
//                                                                data.text
                                                                        ...
                                                                        pdfMake.createPdf(docDefinition).download("vehicleFleet_report.pdf");
                                                                    }
                                                                });
                                                            }
