...
%>
   <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #ed1c24;" width: 227px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon rotate-n-15"></div>
                    <div class="sidebar-brand-text mx-3"><span>Lorenzo</span></div><img src="assets/img/logo.jpg" style="width: 66px;height: 72px;">
                </a>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <div>
                        	...
                        	<i class="fas fa-bars"></i>&nbsp;<span>Management Tables</span></a>
                            <div class="collapse " id="collapse-2">
                                <div class="bg-white border rounded py-2 collapse-inner" style=" border-style: none;border-color: rgb(78,110,205);width: 209.087px;margin-left: -9px;">
	                                ...
	                                <i class="fa fa-check-square" style="margin-right: 19px;margin-left: -12px;"></i>Booking Management</a>
	                                <a class="collapse-item" href="VehicleManegment.jsp">
	                                <i class="fa fa-cab" style="margin-right: 19px;margin-left: -12px;"></i>VehicleFleet Management</a>
	                                ...
	                                <a class="collapse-item" href="VehicleReturnManagment.jsp">
	                                <i class="fa fa-wrench" style="margin-right: 19px;margin-left: -12px;"></i>Vehicle Return Details</a>
	                                <a class="collapse-item" href="VehicleMaintainesManegment.jsp">
	                                <i class="fa fa-cab" style="margin-right: 19px;margin-left: -12px;"></i>Vehicle Maintain</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <span>&nbsp;Go To Home Page</span></a></li>
                    <%} %>
                </ul>
