...
import com.lorenzo.interfaces.Iresarvation;
...
public class Sresarvation implements Iresarvation{
	...
	public ArrayList<Resarvation> getResarvationList() {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.resarvation  ";
	...
	public Resarvation getResarvation(int id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.resarvation where id='"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public ArrayList<Resarvation> getResarvationByUserId(int userId) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.resarvation where userId='"+userId+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public ArrayList<Resarvation> getResarvationByStatus(String status) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.resarvation where status='"+status+"'  ";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public boolean addResarvation(Resarvation resarvation) {
		...
		try {
	        ...
	        statement = (Statement) connection.createStatement();
	         ...
	         //sql query
	        String sql = " INSERT INTO lorenzo.resarvation  (  `userId`,`vehicalId`, `pickLocation`, `dropLocation`, `time`, `date`, `vehicleType`, `status` ) VALUES"
	...
	public boolean updateResarvation(Resarvation resarvation) {
		//create return statement
		  	  ...
		  	  try {
			         ...
			         statement =  (Statement) connection.createStatement();
			          //create sql query
			          String sql ="UPDATE lorenzo.resarvation SET  `vehicalId` = '"+resarvation.getVehicleId()+"', `pickLocation` = '"+resarvation.getPickupLocation()+"'"
	...
	public boolean deleteResarvation(int id) {
		...
		try {
            ...
            statement =  (Statement) connection.createStatement();
            //sql query statement
            String sql = "DELETE FROM lorenzo.resarvation WHERE (`id` = '"+id+"');";
	...
	public boolean clangeResarvationStatus(int id, String status) {
  	  ...
  	  try {
	         ...
	         statement =  (Statement) connection.createStatement();
	          //create sql query
	          String sql ="UPDATE lorenzo.resarvation SET  `status` = '"+status+"'  WHERE (`id` = '"+id+"');";
	        		  //
