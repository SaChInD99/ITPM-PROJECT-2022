...
public class Srating implements Irating{
	...
	public ArrayList<Rating> getRatingList() {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.rating  ";
	...
	public Rating getRating(int id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.rating where customerId='"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public boolean addRating(Rating rating) {
		...
		try {
	        ...
	        statement = (Statement) connection.createStatement();
	         ...
	         //sql query
	        String sql = " INSERT INTO lorenzo.rating  (`customerId`,  `stars`,`description`  ) VALUES"
	...
	public boolean updateRating(Rating rating) {
		  	  ...
		  	  try {
			         ...
			         statement =  (Statement) connection.createStatement();
			          //create sql query
			          String sql ="UPDATE lorenzo.rating SET  `stars` = '"+rating.getRating()+"',"
	...
	public boolean deleteRating(int id) {
		...
		try {
            ...
            statement =  (Statement) connection.createStatement();
            //sql query statement
            String sql = "DELETE FROM lorenzo.rating WHERE (`id` = '"+id+"');";
