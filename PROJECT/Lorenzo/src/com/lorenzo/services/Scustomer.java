...
import com.lorenzo.interfaces.Icustomer;
...
public class Scustomer implements Icustomer{
	...
	public ArrayList<Customer> getCustomerList() {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.customer  ";
	...
	public Customer getCustomer(int id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.customer  WHERE id = '"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
...
boolean isSuccess = false;
		...
		try {
	        ...
	        statement =  connection.createStatement();
	         ...
	         //sql query
	        String sql = " INSERT INTO lorenzo.customer  (  `name`,`mail`, `telephone`, `gender`, `userName`, `password`) VALUES"
	...
	public boolean updateCustomer(Customer customer) {
  	  ...
  	  try {
	         ...
	         statement =    connection.createStatement();
	          //create sql query
	          String sql ="UPDATE lorenzo.customer SET  `name` = '"+customer.getName()+"', `mail` = '"+customer.getMail()+"',"
	...
	public boolean deleteCustomer(int id) {
		...
		try {
            ...
            statement =    connection.createStatement();
            //sql query statement
            String sql = "DELETE FROM lorenzo.customer WHERE (`id` = '"+id+"');";
