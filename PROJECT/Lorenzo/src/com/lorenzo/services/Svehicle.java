...
public class Svehicle implements Ivehicle{
	...
	public ArrayList<Vehicle> getVehicleList() {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.vehicle  ";
	...
	public Vehicle getVehicle(String id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.vehicle where vehicleNumber='"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public ArrayList<Vehicle> getVehicleByStatus(String status) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.vehicle where status='"+status+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public boolean addvehicle(Vehicle vehicle) {
		...
		try {
	        ...
	        statement = (Statement) connection.createStatement();
	         ...
	         //sql query
	        String sql = " INSERT INTO lorenzo.vehicle  (`vehicleNumber`,  `numberOfPasenger`,`vehicleType`, `address`, `status`, `ownerName` ) VALUES"
	...
	public boolean updateVehicle(Vehicle vehicle) {
  	  ...
  	  try {
	         ...
	         statement =  (Statement) connection.createStatement();
	          //create sql query
	          String sql ="UPDATE lorenzo.vehicle SET  `numberOfPasenger` = '"+vehicle.getNoOfPasenger()+"',"
	...
	public boolean deleteVehicle(String id) {
		...
		try {
            ...
            statement =  (Statement) connection.createStatement();
            //sql query statement
            String sql = "DELETE FROM lorenzo.vehicle WHERE (`vehicleNumber` = '"+id+"');";
	...
	public void changeVehicleStatus(String status,String id) {
		//set object value to local variables
	  	  ...
	  	  try {
		         ...
		         statement =  (Statement) connection.createStatement();
		          //create sql query
		          String sql ="UPDATE lorenzo.vehicle SET  `status` = '"+status+"'  WHERE (`vehicleNumber` = '"+id+"');";
