...
<head>
    ...
    <title>Customer Table - Lorenzo</title>
       ...
       <jsp:include page="header.jsp"/>
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4" style="background: red;">Customer Management</h3>
                <div class="row">
                        <div class="col"><a href="customerRegister.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: black;">Register New Customer</button></a> <a href="report/customer.jsp"> <button class="btn btn-primary" type="button" style="margin-bottom: 26px; background: #ed1c24;">Generate Report</button></a></div>
                    </div>
