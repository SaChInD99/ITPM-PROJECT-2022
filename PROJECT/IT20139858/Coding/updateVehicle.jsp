                        ...
                        <div class="p-5">
                            ...
                            %>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="number" id="exampleFirstName-2" placeholder="Number of pasenger seats" name="noOfPAsengers" value="<%=vehicle.getNoOfPasenger() %>"  style="border-radius: 0px;" required="required"></div>
                                </div>
                               ...
                               <div class="row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><textarea class="form-control form-control-lg" name="address" placeholder="Address" style="height: 135.2px;font-size: 12.8px;width: 220px;border-radius: 0px;"><%=vehicle.getAddress() %></textarea></div>
