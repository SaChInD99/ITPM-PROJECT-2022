...
<%--
String vehicle = "com.mysql.jdbc.vehicle";
String connectionUrl = "jdbc:mysql://localhost:3306/";
String database = "lorenzo";
String userid = "root";
String password = "";
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col"><a href="addVehicle.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 29px;">Add Vehicle</button></a><button class="btn btn-primary" type="button" style="margin-bottom: 29px;margin-left: 11px;">Generate Report</button></div>
                    </div>
...
String sql ="select * from vehicleNumber where vehicleType="+"' ";
...
<td><%=resultSet.getString("numberOfPasenger") %></td>
</tr>
<%
}
connection.close();
                    ...
                    <form class="user">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6"><label class="form-label">Vehicle type</label>
                                <div class="form-check" style="width: 116px;padding-left: 24px;"><input class="form-check-input" type="radio" id="formCheck-1" name="gender"><label class="form-check-label" for="formCheck-1">Toyota Aqua</label></div>
                                <div class="form-check" style="width: 100px;"><input class="form-check-input" type="radio" id="formCheck-4" name="gender"><label class="form-check-label" for="formCheck-2">Volkswagon Polo</label></div>
                                <div class="form-check" style="width: 100px;"><input class="form-check-input" type="radio" id="formCheck-3" name="gender"><label class="form-check-label" for="formCheck-2">Toyota Hiace KDH </label></div>
                                <div class="form-check" style="width: 100px;"><input class="form-check-input" type="radio" id="formCheck-5" name="gender"><label class="form-check-label" for="formCheck-2">Toyota Axio</label></div>
                                <div class="form-check" style="width: 100px;"><input class="form-check-input" type="radio" id="formCheck-5" name="gender"><label class="form-check-label" for="formCheck-2">Nissan X-trail</label></div>
                            </div>
                        </div>
