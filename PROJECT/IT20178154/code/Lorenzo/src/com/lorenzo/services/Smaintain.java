...
import com.lorenzo.interfaces.Imaintain;
...
public class Smaintain implements Imaintain{
	...
	public ArrayList<Maintaine> getMaintaineList() {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.maintaines  ";
	...
	public ArrayList<Maintaine> getMaintaineByVehicleId(String id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.maintaines  WHERE vehicalId = '"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public Maintaine getMaintaine(int id) {
		...
		try {
	            ...
	            String sql = "SELECT * FROM lorenzo.maintaines  WHERE id = '"+id+"'";
	            PreparedStatement statement =  connection.prepareStatement(sql);
	...
	public boolean addMaintaine(Maintaine maintaine) {
		...
		try {
	        ...
	        statement = (Statement) connection.createStatement();
	         ...
	         //sql query
	        String sql = " INSERT INTO lorenzo.maintaines  (  `vehicalId`,`status`, `qty`, `partId`, `description`, `date`) VALUES"
	...
	public boolean updateMaintaine(Maintaine maintaine) {
  	  ...
  	  try {
	         ...
	         statement =  (Statement) connection.createStatement();
	          //create sql query
	          String sql ="UPDATE lorenzo.maintaines SET  `vehicalId` = '"+maintaine.getVehicleId()+"', `status` = '"+maintaine.getStatus()+"'"
	...
	public boolean deleteMaintaine(int id) {
		...
		try {
            ...
            statement =  (Statement) connection.createStatement();
            //sql query statement
            String sql = "DELETE FROM lorenzo.maintaines WHERE (`id` = '"+id+"');";
