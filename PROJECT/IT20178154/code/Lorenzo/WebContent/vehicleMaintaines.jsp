...
<head>
    ...
    <title>Vehicle Maintain - Lorenzo</title>
...
<body> <style>
    body  {
       background-image: url("assets/img/mainv.jpg");
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="addMaintain" method="post">
                                ...
                                <hr><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-green);border-color: var(--bs-green);width: 527px;margin-bottom: 7px;">Submit</button><a href="VehicleMaintainesManegment.jsp" class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">View Table</button>
                                </hr>
                            </form>
