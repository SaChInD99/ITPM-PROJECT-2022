            ...
            <div id="content" style="background: black;">
                ...
                <div class="container-fluid" style="background: white;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="padding-top: 33px;">
                        ...
                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#" style="color: var(--bs-Black);background: var(--bs-red);border-style: none;border-color: var(--bs-black);"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                   		<%} %>
                   		
         
                    </div>
                    <div class="col"><a href="customerRegister.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 29px;">Customer Register</button></a>
                    <div class="col"><a href="home.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 29px;">Back To Home Page</button></a>
   
          

                    <div class="row jello animated">
                        <div class="col" style="border-style: none;"><img class="tada animated" src="assets/img/dash.jpg"></div>
                         <br>
          <br>
                    <br>
          <br>
          ...
          <br>
                      ...
                      <%if (user != null && user.getUserType().equals("employee")){%>
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col" style="margin-right: -50px;padding-right: 0px;padding-left: 0px;"><a href="addVehicle.jsp" class="btn btn-primary bounce animated" type="button" style="width: 100px;height: 100px;margin-right: 0px;margin-left: 0px;border-bottom-left-radius: 50px;border-top-left-radius: 50px;border-style: none;background: var(--bs-red);"><i class="fa fa-plus" style="margin-right: 41px;margin-left: 32px;"></i>add a new vehicle</a></div>
