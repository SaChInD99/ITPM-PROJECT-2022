    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col"><a href="AccedentCoverage.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 29px;">Add New Record</button></a><button class="btn btn-primary" type="button" style="margin-bottom: 29px;margin-left: 11px;">Generate Report</button></div>
                    </div>
                </div>
